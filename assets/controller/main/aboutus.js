        ...
        <div class="col-sm-5 d-none d-lg-block" id="myScrollspy">
          <div class="list-group">
            ...
            <a class="list-group-item list-group-item-action" href="#section4"
              >Have Backbone; Disagree and Commit</a
            >
            <a class="list-group-item list-group-item-action" href="#section5"
              >Success and Scale Bring Broad Responsibility</a
            >
          </div>
        </div>
        <div class="col-sm-7">
          ...
          <br>
              <hr>
              <br>
            <h2>Are Right, A Lot</h2>
              <p>
                Leaders are right a lot. They have strong judgment and good
                instincts. They seek diverse perspectives and work to disconfirm
                their beliefs.
              </p>
              ...
              <h2>Hire and Develop the Best</h2>
              <p>
                Leaders raise the performance bar with every hire and promotion.
                They recognize exceptional talent, and willingly move them
                throughout the organization. Leaders develop leaders and take
                seriously their role in coaching others. We work on behalf of
                our people to invent mechanisms for development like Career
                Choice.
              </p>
              <h2>Insist on the Highest Standards</h2>
              <p>
                ...
                raising the bar and drive their teams to deliver high-quality
                products, services, and processes. Leaders ensure that defects
                do not get sent down the line and that problems are fixed so
                they stay fixed.
              </p>
          </div>
          ...
          <br>
            ...
            <h2>Think Big</h2>
              ...
              <p>
                ...
                is awkward or embarrassing. Leaders do not believe their or
          ...
          <br>
            ...
            <h2>Have Backbone; Disagree and Commit</h2>
              ...
              <h2>Strive to be Earth’s Best Employer</h2>
              <p>
          ...
          <br>
              <hr>
              <br>
            <h2>Success and Scale Bring Broad Responsibility</h2>
              <p>
                We started in a garage, but we’re not there anymore. We are big,
                we impact the community, and we are far from perfect. We must be
                humble and thoughtful about even the secondary effects of our
                actions. Our local communities, environment, and future generations
                need us to be better every day. We must begin each day with a
                determination to make better, do better, and be better for our
                customers, our employees, our partners, and the world at large.
                And we must end every day knowing we can do even more tomorrow.
                Leaders create more than they consume and always
              </p>
          </div>
