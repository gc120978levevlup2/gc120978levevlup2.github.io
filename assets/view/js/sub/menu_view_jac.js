                    ...
                    <div class="collapse navbar-collapse navbar-expand-xl px-3" id="navbarCollapse">
                        <ul class="navbar-nav me-auto mb-2 mb-md-0">
                            ...
                            <li class="nav-item ${hide_sel["buyer_about"]}">
                                <a class="nav-link ${selection["buyer_about"]}"  href="/assets/module_jac/about.html">
                                    About
                                </a>
                            </li>
                            <li class="nav-item ${hide_sel["buyer_merch"]}">
                                <a class="nav-link ${selection["buyer_merch"]}"  href="/assets/module_jac/merchandise.html">
                                    Merchandise
                                </a>
                            </li>
                            <!-- Customize for this file only -->
                        ...
                        <hr>
                        <!-- Customize for this file only -->
                        <form class="d-flex me-2" role="search" action="/assets/module_jac/search_psalm.html">
