...
// model
import { read_user, user_is_logged_in } from "/assets/model/local/login_user.js"
                    ...
                    <div class="collapse navbar-collapse navbar-expand-xl px-3" id="navbarCollapse">
                        <ul class="navbar-nav me-auto mb-2 mb-md-0">
                            <li class="nav-item ${hide_sel["home"]}">
                                <a class="nav-link ${selection["home"]}" href="/assets/module_ds/"> <!-- Customize for this file only -->
                                    Index
                                </a>
                            </li>
                            <!-- Customize for this file only -->
                            <li class="nav-item ${hide_sel["buyer_about"]}">
                                <a class="nav-link ${selection["buyer_about"]}"  href="/assets/module_ds/#aboutus">
                                    About
                                </a>
                            </li>
                            <li class="nav-item ${hide_sel["buyer_merch"]}">
                                <a class="nav-link ${selection["buyer_merch"]}"  href="/assets/module_ds/merchandise.html">
                                    Merchandise
                                </a>
                            </li>
                            <!-- Customize for this file only -->
