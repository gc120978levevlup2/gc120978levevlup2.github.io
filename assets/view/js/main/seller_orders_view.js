      ...
      <div class="container mb-3">
        <div class="row">
          <div class="col-md-12 m-3">
            <div class="row">
                <div class="col-sm-4">
                    <h2 style="float:left"><b>myOrders</b></h2>                  
                </div>
                <div class="col-sm-8">
                </div>
            </div>
                                        ...
                                        <div class="col-md-8">
                                            ...
                                            <div class="form-floating col-md-12">
                                                <select type="text" class="form-control" id="status_update2" name="status_update2" placeholder="#" required>
                                                    ...
                                                    <option>030. Item sent to the Courier</option>
        ...
        <div class="row row-cols-md-2 row-cols-lg-3 row-cols-xl-4 row-cols-xxl-5 g-3" id="seller-orders-list">
